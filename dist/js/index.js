...
/* harmony export */ });
/* harmony import */ var _data_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(732);
/* harmony import */ var _footer_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(592);
/* harmony import */ var _preloader_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(422);
/* harmony import */ var _localStorage_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(424);
/* eslint-disable max-len */
...
const renderProductInfo = async () => {
  ...
  addToBasketBtn.addEventListener('click', () => {
    const getData = (0,_localStorage_js__WEBPACK_IMPORTED_MODULE_2__/* .getStorage */ .cF)('basket');
    console.log(getData);
    ...
    if (getData.length > 0) {
      ...
      if (storageItem >= 0) {
        ...
        (0,_localStorage_js__WEBPACK_IMPORTED_MODULE_2__/* .setStorage */ .po)('basket', data);
        (0,_localStorage_js__WEBPACK_IMPORTED_MODULE_2__/* .renewBasketQuantity */ .xC)();
      }
    } else {
      data.count = 1;
      alert('Товар добавлен в корзину');
  ...
  if (loader) {
    setTimeout(() => {
      ...
      categoryCrumb.addEventListener('click', e => {
        e.preventDefault();
        (0,_data_js__WEBPACK_IMPORTED_MODULE_3__/* .httpRequest */ .c)(`https://hidden-castle-31466.herokuapp.com/api/goods`, {
          method: 'GET',
